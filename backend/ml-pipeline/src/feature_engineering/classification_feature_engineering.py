...
Creates engineered features for the Cold Chain Classification Pipeline.
...
class ClassificationFeatureEngineering:
    ...
    def validate_engineered_features(self):
        ...
        for feature in engineered_features:
            ...
            if np.isinf(self.df[feature]).any():
    ...
    def save_dataset(self):
        ...
        output_file = (
            ...
            "classification_train_engineered.csv"
...
if __name__ == "__main__":
    ...
    pipeline = ClassificationFeatureEngineering(
        version="v1"
    )
